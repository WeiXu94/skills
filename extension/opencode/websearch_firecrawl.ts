/**
 * websearch_firecrawl — opencode custom tool: web search via Firecrawl POST /v2/search.
 *
 ...
 * when present, otherwise no auth header. Filename = tool name ("websearch_firecrawl").
 * Named uniquely to avoid clash with opencode's gated built-in "websearch" (Exa).
 *
